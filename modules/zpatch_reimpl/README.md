...
- `SplitscreenFix`: mounts the repo-owned split-screen menu archive and enables the dormant native split paths only while the game reports `GM_SPLITSCREEN`; the current public capability is two or three local players.
